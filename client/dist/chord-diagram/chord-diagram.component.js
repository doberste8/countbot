...
var custom_chord_sort_1 = require("./custom.chord.sort");
var ChordComponent = (function () {
    ...
    ChordComponent.prototype.ngOnChanges = function () {
        if (this.chart) {
            this.updateChart();
        }
    };
    ChordComponent.prototype.createChart = function () {
        ////////////////////////////////////////////////////////////
        //////////////////////// Set-Up ////////////////////////////
        ////////////////////////////////////////////////////////////
        var chartID = this.id;
        var groupSort = parseInt(this.sort);
        var Names = this.data.slice(0, 1)[0];
        var matrix = this.data.slice(1);
        var chart = d3.select("#" + chartID).select("div");
        var margin = { left: 20, top: 20, right: 20, bottom: 20 }, width = chart.node().getBoundingClientRect().width - margin.left - margin.right, height = chart.node().getBoundingClientRect().width - margin.top - margin.bottom, innerRadius = width * .42, outerRadius = innerRadius * 1.07, opacityDefault = .8, transDur = 500;
        ////////////////////////////////////////////////////////////
        /////////// Create scale and layout functions //////////////
        ////////////////////////////////////////////////////////////
        var chord = custom_chord_sort_1.default()
            .padAngle(0.025)
    ...
    ChordComponent.prototype.updateChart = function () {
    };
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], ChordComponent.prototype, "id", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array)
    ], ChordComponent.prototype, "data", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], ChordComponent.prototype, "sort", void 0);
    ChordComponent = __decorate([
        core_1.Component({
...
exports.ChordComponent = ChordComponent;
